...
public class ProcessoSeletivo{
    ...
    static void imprimirSelecionados(){
        ...
        System.out.println("Imprimindo a lista de candidatos, informando o índice dos elementos:");

        for(int index=0; index < candidatos.length; index++){
            System.out.println("O candidato de nº "+ (index+1) + ". É o "+ candidatos[index]);
        }
